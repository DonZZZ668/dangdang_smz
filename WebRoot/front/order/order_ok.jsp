	...
	<head>
		...
		<script type="text/javascript">
				...
				function fun(){
					$("#time").html(--i);
					if(i==0){
						location.href="${pageContext.request.contextPath}/book/main";
					}
				}
		</script>
	</head>
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h6>
					您刚刚生成的订单号是：<font color="red"><strong>${sessionScope.orderNum }</strong></font>，
					金额总计<font color="red"><strong>${sessionScope.total }</strong></font>
				</h6>

				<ul>
					<li class="nobj">
						您现在可以：还有<font color="red"><strong><div id="time"></div></strong></font>秒,回到首页！！！
