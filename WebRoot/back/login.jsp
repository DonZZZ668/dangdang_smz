...
<script type="text/javascript" src="/jquery_day2/pm/jquery-1.8.3.js"></script>
	  <script type="text/javascript">
	  	function changeImage1(tag){
	  		$(tag).prev().children().first().attr("src","${pageContext.request.contextPath }/admin/getCode?"+new Date());
	  	}
	  	function changeImage(tag){
	  		$(tag).attr("src","${pageContext.request.contextPath }/admin/getCode?"+new Date());
	  	}
	  </script>
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" onclick="changeImage(this)" src="${pageContext.request.contextPath }/admin/getCode" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
										<a id="vcodeImgBtn" name="change_code_link" class="code_picww" onclick="changeImage1(this)" href="javascript:changeImage()">换张图</a> 
