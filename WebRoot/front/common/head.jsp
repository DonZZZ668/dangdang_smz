	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> 
				<span class="little_n">
					| <a href="${pageContext.request.contextPath}/book/main" name="mydangdang" class="head_black12a">我的当当</a> | 
		...
		[&nbsp;<a href="${pageContext.request.contextPath}/user/signOut" class="b">登出</a>&nbsp;]
	...
	<div class="head_head_list">
		<div class="head_head_list_left">
			<span class="head_logo">
				<a href="${pageContext.request.contextPath}/book/main" name="backtobook">
